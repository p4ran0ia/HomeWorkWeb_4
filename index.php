...
$workExp = [
	[
    	'work' => '4-ая работа :)',
        'date' => 'Фев 2019 - Дек 2022',
        'description' => 'Это моя 4-ая работа и я на ней что-то делал :)',
	], 
    [
    	'work' => '3-ая работа :)',
        'date' => 'Апр 2016 - Фев 2019',
        'description' => 'Это моя 3-ая работа и я на ней что-то делал :)',
	], 
    [
    	'work' => '2-ая работа :)',
        'date' => 'Сент 2012 - Апр 2016',
        'description' => 'Это моя 2-ая работа и я на ней что-то делал :)',
	], 
    [
    	'work' => '1-ая работа :)',
        'date' => 'Окт 2009 - Сент 2012',
        'description' => 'Это моя 1-ая работа и я на ней что-то делал :)',
	], 
];
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b>
                <?php echo $workExp[$i]['work']; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
                <?php echo $workExp[$i]['date']; ?></h6>
